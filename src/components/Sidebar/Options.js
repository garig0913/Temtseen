...
const Index = (props) => {
  ...
  return (
    <>
      ...
      >
        <div className="w-full h-full pl-20 pr-4 flex flex-col relative bg-white border-r border-gray-600">
          <Btn
          ...
          <h1 className="text-lg font-semibold pb-3 mt-14 text-black">Filters</h1>

          <div className="flex flex-col">
            <div style={{ borderTop: "1px solid #aeb5bf" }} className="flex flex-col pb-6">
              <h1 className="font-semibold text-gray-500 my-4">Freelancer Country</h1>
              <div
                style={
                  countryFocus
                    ? {
                ...
                className="flex items-center py-2 border border-gray-400 rounded"
              >
                <BiSearch className="text-gray-500 mx-2 text-xl" />
                <input
            ...
            <form>
              <div style={{ borderTop: "1px solid #aeb5bf" }} className="flex flex-col pb-6">
                <div className="flex items-center justify-between">
                  <h1 className="font-semibold text-gray-800 my-4">Price</h1>
                ...
                >
                  ...
                  <div className="w-full flex justify-between h-10 mt-4">
                    <div style={{ width: "72%" }} className="h-full flex justify-between">
                      <input
                        style={{ width: "47%" }}
                        className="py-2.5 border border-gray-500 focus:outline-none pl-2 rounded"
                      />
                      <input
                        style={{ width: "47%" }}
                        className="py-2.5 border border-gray-500 focus:outline-none pl-2 rounded"
            ...
            <div style={{ borderTop: "1px solid #aeb5bf" }} className="flex flex-col pb-6">
              <h1 className="font-semibold text-gray-800 my-4">More Filters</h1>
              <div className="flex items-center gap-3">
                <label class="switch">
                  <input type="checkbox" />
                  <span class="slider round"></span>
                </label>
                <h1 className="text-gray-500 mb-0.5">Recently added</h1>
              </div>
            </div>
          </div>
        </div>
