          ...
          <div id="PostJobGrid1" className="bg-white rounded-sm p-4 flex flex-col">
            ...
            <div className="flex">
              <div className="w-full">
                <label className="text-sm text-gray-500 font-semibold" htmlFor="PostJobOption">
                  CATEGORY
                </label>
                <select
                ...
                >
                  ...
                  <option className="text-sm font-semibold" value="volvo">
                    Volvo
                  </option>
                  <option className="text-sm font-semibold" value="saab">
                    Saab
                  </option>
                  <option className="text-sm font-semibold" value="opel">
                    Opel
                  </option>
                  <option className="text-sm font-semibold" value="audi">
                    Audi
                  </option>
                </select>
              </div>
              ...
              <div className="w-full">
                ...
                <select
                  disabled={secondSelect ? false : true}
                  style={
                    secondSelect ? { opacity: "1" } : { opacity: "0.5", cursor: "not-allowed" }
                  }
                  onClick={
                    secondSelect ? () => console.log("allowed") : () => console.log("not allowed")
                  }
                  className="w-11/12 pl-2 py-1.5 focus:outline-none border rounded"
                  id="PostJobOption"
                >
