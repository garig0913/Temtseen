   ...
   return (
      <>
         <Desktop>
            <div
               id="container"
               className="flex flex-col items-center bg-gray-200 py-14 dark:bg-gray-900"
            >
               <h1 className="text-5xl font-light text-gray-700 my-12 dark:text-gray-300">
                  ...
                  {data.map((content) => {
                     return (
                        <div
                           ...
                           className="flex flex-col justify-between p-6 h-96 w-96 bg-white shadow-md dark:bg-gray-700"
                        >
                           <div>
                              <GoQuote className="text-3xl text-blue-500" />
                              <p className="font-light mt-4 dark:text-gray-200">
                                 {content.text}
                              </p>
                           </div>
                           <div className="flex">
         ...
         <Tablet>
            <div
               id="container"
               className="flex flex-col items-center bg-gray-200 py-14"
            >
               <h1 className="text-5xl font-light text-gray-700 my-12">
                  Hear from our Clients
               </h1>
               <div className="flex">
                  <h1 className="mb-16">
         ...
         <Mobile>
            <div
               ...
               className="flex flex-col items-center bg-gray-200 py-14"
            >
               <h1 className="text-4xl font-light text-gray-800 my-12">
                  Hear from our Clients
               </h1>
